...
export default {
  ...
  data() {
    ...
    var self=this;
        axios.get('http://49.234.86.39:8080/qujing/admin/feedbackManage/showDetail.do',{params: {id:self.ID}})
           .then(response => {
   ...
   //处理反馈已读按钮
      handleDelete() {
      var self=this;
      axios.get('http://49.234.86.39:8080/qujing/admin/feedbackManage/deletetask.do',{params: {id:self.detail.backID}})
           .then(response => {
      ...
      handleUndelete() {
      var self=this;
      axios.get('http://49.234.86.39:8080/qujing/admin/feedbackManage/legaltask.do',{params: {id:self.detail.backID}})
           .then(response => {
